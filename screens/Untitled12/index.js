...
const Untitled12 = ({
  ...
  return <View style={styles.container}>
      <View style={styles.column1}><Pressable onPress={() => navigation.navigate("Untitled13")}><ImageBackground style={styles.wswVDUfX} source={{
        ...
        }} resizeMode="cover"></ImageBackground></Pressable></View>
      <Pressable onPress={{}}><View style={styles.column2}></View></Pressable>
