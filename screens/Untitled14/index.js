...
const Untitled14 = ({
  ...
  return <View style={styles.container}>
    ...
    <Pressable onPress={{}}><View style={styles.TfjgRMNG}></View></Pressable><Pressable onPress={{}}><ImageBackground style={styles.NqvuVIEp} source={{
      ...
      }} resizeMode="cover"></ImageBackground></Pressable><TextInput style={styles.nkrkxjHK}></TextInput><FlatList style={styles.XImaVbiP} renderItem={() => <View style={styles.MnpAifoo}><Text style={styles.EIMKLHXd}>Lorem ipsum…</Text></View>} ItemSeparatorComponent={() => <View style={styles.xDLuZNHR} />} data={[1, 2, 3]} keyExtractor={item => item.toString()}></FlatList></View>;
};
